...
/*
# In addition to the voter verification, registration, and voting functions; I 
# have also implemented Winner and Multiple Owners (extra challenge). As a 
# contract creator, I have also mandated the users to have minimum 5 tokens
# to participate in voting.

# Step 1: Bootstrap the contract with the appropriate values. In addition to the
# contract creator, feel free to add more co-owners.
# ["0x14723a09acff6d2a60dcdf7aa4aff308fddc160c"],1,5

# Step 2. To avoid spam, I have mandated users to buy tokens. Use buy() function.

# Step 3: Owners can register the voters. As the assignment requirement is only
# owners can register voters, voter address needs to be passed to the argument
...
# Step 4: Each verified voter cast their vote for SATOSHI, GREGOR, NAUMAN and so we know the
# outcome of this election already. 
# 0
# 0
# 0
